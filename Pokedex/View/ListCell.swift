...
class ListCell: UICollectionViewCell {
    ...
    func setupViews() {
        ...
        pokeImage.anchor(top: nil, leading: nil, bottom: self.bottomAnchor, trailing: self.trailingAnchor, padding: UIEdgeInsets(top: 0, left: 0, bottom: 5, right: 5), size: CGSize(width: 40, height: 40))
    }
}
